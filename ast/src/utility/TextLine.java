 ...
 *  This class will display line numbers for a related text component. The text
  component must use the same line height for each line. TextLine
	...
	implements CaretListener, DocumentListener, PropertyChangeListener
{
	...
	//  Text component this Texttextline component is in sync with
  ...
  <li>TextLine.RIGHT (default)
	...
	public void paintComponent(Graphics g)
	{
		...
		while (rowStartOffset <= endOffset)
		{
			try
            {
    			...
    			String lineNumber = gettextline(rowStartOffset);
	 ...
	 */
	protected String gettextline(int rowStartOffset)
	{
		Element root = component.getDocument().getDefaultRootElement();
